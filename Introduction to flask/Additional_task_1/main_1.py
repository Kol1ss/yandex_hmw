...
# После запуска программы переходим по ссылке: http://127.0.0.1:8080/sample_file_upload
# Выбираем фотографию и жмём на кнопку "Отправить"
# После у нас появится картинка, которую мы выбрали
